...
"products/company-operations/projects/docusaurus-documentation/Documentation Project Set Up and Process.md": {
	id: "products/company-operations/projects/docusaurus-documentation/Documentation Project Set Up and Process.md";
  slug: "products/company-operations/projects/docusaurus-documentation/documentation-project-set-up-and-process";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".md"] };
