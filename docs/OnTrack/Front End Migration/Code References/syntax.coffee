...
animal = new Animal $("#sell").click(animal.sell)
  ...
  # prototypal inheritance to automatically inherit all of a class’s instance properties
  # Not need to do 
...
# CoffeeScript has already reserved in for use with arrays. Instead, the operator has been renamed of, 
...
#classToType is completely private, and can never again be referenced outside the executing anonymous function.
classToType = {}
for name in types
